# Builds Release output and creates a Jellyfin catalog .zip (dll + meta.json).
...
$zipName = "live-matches_1.3.0.0.zip"
...
Write-Host ""
Write-Host "Upload this zip to GitHub Release v1.3.0 as: $zipName"
